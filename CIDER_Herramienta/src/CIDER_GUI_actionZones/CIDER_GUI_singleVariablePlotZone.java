 ...
 * @author laptop
 */
public class CIDER_GUI_singleVariablePlotZone extends CIDER_GUI_statPlotZone{
 public CIDER_GUI_singleVariablePlotZone(CIDER_DB parentDB, PApplet parent) {
  super(parentDB, parent);
 }
 public CIDER_GUI_singleVariablePlotZone(CIDER_DB parentDB, PApplet parent, PVector position, float objectWidth, PImage backgroundImage) {
 ...
 public void onCollision(CIDER_GUI_Object object) {
  if(object instanceof CIDER_GUI_variableFilter){
   resultingPlot = new CIDER_GUI_singleVariableStatPlotDisplaySurface(parentDB, parent, new PVector(position.x,position.y), parent.width*0.25f, parent.height*0.25f, parent.width, parent.height);
