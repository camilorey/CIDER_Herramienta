 ...
 * @author laptop
 */
public class CIDER_GUI_ComparativoActionZone extends CIDER_GUI_twoVariablePlotZone{

 

 public CIDER_GUI_ComparativoActionZone(CIDER_DB parentDB, PApplet parent) {
  super(parentDB, parent);
 }

 public CIDER_GUI_ComparativoActionZone(CIDER_DB parentDB, PApplet parent, PVector position, float objectWidth, PImage backgroundImage) {
  super(parentDB, parent, position, objectWidth, backgroundImage);
 }
 @Override
 public void createStatPlot() {
  resultingPlot = new CIDER_GUI_ComparativoPlotSurface(parentDB, parent, new PVector(position.x,position.y), parent.width*0.25f, parent.height*0.25f, parent.width, parent.height);
